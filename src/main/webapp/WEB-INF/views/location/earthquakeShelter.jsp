<%--
/**
	Class Name: earthquakeShelter.jsp
	Description: 지진대피장소
	Author: Jinseo
    ...
    <div id="containerWrap">
            ...
            <div id="shelterSelect">
			    <ul class="nav nav-tabs99">
			        <li class="nav-item">
			            <a id="shelter30" href="/ehr/location/location/3" title="선택됨" tabindex="0" class="nav-link active99">지진옥외대피장소</a>
			        <li class="nav-item">
	    ...
	    <nav aria-label="Page navigation">
	        ...
	        <h5 class="mt-4">소관부서 : 지진방재관리과 (044-205-5192)</h5>
	    </nav>
	</div>
</div>
