<%--
/**
	Class Name: chemicalIncidentShelter.jsp.jsp
	Description: 화학사고 대피장소
	Author: Jinseo
 ...
 <div id="containerWrap">
	    ...
	    <div class="container-sm" id="content" style="display: block;">
	        <div class="level1_titleWrap">
	          <h2 class="level1_title">화학사고 대피장소</h2>
	        </div>
	    ...
	    <nav aria-label="Page navigation">
	        ...
	        <h5 class="mt-4">소관부서 : 화학물질안전원 임지영(044-830-4167)</h5>
	    </nav>
	</div>
</div>
